...
const InstituteDetails = () => {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <div className="bg-red-50 border border-red-200 rounded-3xl p-6 sm:p-8 max-w-md mx-auto">
            <p className="text-red-600 mb-4">{error}</p>
            <button
              onClick={fetchSchoolData}
              className="bg-gray-800 text-white px-6 py-3 rounded-2xl hover:bg-gray-700 transition-all duration-300 text-sm sm:text-base"
            >
              Try Again
            </button>
          </div>
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16">
            <button
              onClick={() => navigate("/alumni/home")}
              className="flex items-center space-x-2 text-gray-600 hover:text-gray-800 transition-colors duration-300 text-sm sm:text-base"
            >
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              <button
                ...
                className="flex items-center space-x-2 bg-gray-800 text-white px-3 sm:px-4 py-2 rounded-xl sm:rounded-2xl hover:bg-gray-700 transition-all duration-300 text-sm"
              >
                <Share2 className="h-3 w-3 sm:h-4 sm:w-4" />
                <span className="hidden sm:inline">Share School</span>
          ...
          <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 items-start">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start">
                <div className="flex-shrink-0 mx-auto sm:mx-0">
                  <img
                    ...
                    alt={school.name}
                    className="w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-xl sm:rounded-2xl object-cover border border-gray-200"
                  />
                </div>
            ...
            <div className="w-full lg:w-80 bg-gray-50 rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-gray-200">
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                {school.website && (
                  <div className="flex items-center text-gray-600 text-sm sm:text-base">
                    <Globe className="h-3 w-3 sm:h-4 sm:w-4 mr-2 sm:mr-3 flex-shrink-0" />
                    <a
                      href={school.website}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:text-gray-800 flex items-center truncate"
                    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex space-x-4 sm:space-x-8 overflow-x-auto">
            <button
              ...
              className={`py-3 sm:py-4 px-1 border-b-2 font-medium text-xs sm:text-sm transition-colors duration-300 whitespace-nowrap ${
                activeTab === "campaigns"
            ...
            <div>
              ...
              {activeCampaigns.length === 0 ? (
                <div className="text-center py-8 sm:py-12">
                  <div className="bg-gray-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 max-w-md mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                  {activeCampaigns.map((campaign) => (
                    <div
                      key={campaign.id}
                      className="bg-white rounded-2xl sm:rounded-3xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden group"
                    >
                      <div className="p-4 sm:p-6">
                        <div className="flex justify-between items-start mb-3 sm:mb-4">
                          <h3 className="text-base sm:text-lg font-bold text-gray-900 group-hover:text-gray-800 transition-colors line-clamp-2">
                            {campaign.title}
                          </h3>
                          <button
                        ...
                        <div className="mb-3 sm:mb-4">
                          ...
                          <div className="w-full bg-gray-200 rounded-full h-1.5 sm:h-2">
                            <div
                              className="bg-gray-800 h-1.5 sm:h-2 rounded-full transition-all duration-700"
                              style={{
                        ...
                        <div className="space-y-1 sm:space-y-2 mb-3 sm:mb-4">
                          {campaign.start_at && (
                            <div className="flex items-center text-xs sm:text-sm text-gray-600">
                              ...
                              <span className="truncate">
                                Started {formatDate(campaign.start_at)}
                              </span>
                            </div>
                          )}
                        ...
                        <div className="flex gap-2 sm:gap-3">
                          ...
                          <button className="px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 text-gray-700 rounded-xl sm:rounded-2xl hover:bg-gray-50 hover:border-gray-400 transition-all duration-300 font-semibold text-xs sm:text-sm flex items-center justify-center">
              ...
              {completedCampaigns.length === 0 ? (
                <div className="text-center py-8 sm:py-12">
                  <div className="bg-gray-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 max-w-md mx-auto">
                    ...
                    <p className="text-gray-600 text-sm sm:text-base">
                      This school hasn't completed any projects yet.
                    </p>
                  </div>
                </div>
              ) : (
                    ...
                    >
                      <div className="p-4 sm:p-6">
                        <div className="flex items-center justify-between mb-3 sm:mb-4">
                          ...
                          <CheckCircle className="h-4 w-4 sm:h-6 sm:w-6 text-green-500 flex-shrink-0 ml-2" />
                        </div>
                        ...
                        <div className="space-y-1 sm:space-y-2 text-xs sm:text-sm text-gray-600">
                          {campaign.end_at && (
                            <div className="flex items-center">
                              <Calendar className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2 flex-shrink-0" />
                              <span className="truncate">
                                Completed {formatDate(campaign.end_at)}
                              </span>
                            </div>
                          )}
