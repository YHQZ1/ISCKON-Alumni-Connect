...
const AlumniHomePage = () => {
  ...
  const featuredInstitutions = [
    ...
    },
    {
      ...
      description: "Fostering global citizens with comprehensive education and modern learning facilities."
    },
    {
      id: 3,
      ...
      description: "Empowering students with technology and knowledge to excel in the digital age."
    },
    {
      id: 4,
      ...
      description: "Building character and academic excellence through holistic education and community support."
    },
    {
      id: 5,
      ...
      description: "Nurturing creativity and international mindedness in our diverse student community."
    },
  ];
  ...
  const quickStats = [
    { label: "Total Donated", value: `$${currentUser.totalDonated.toLocaleString()}`, icon: DollarSign, color: "text-green-600" },
    { label: "Projects Supported", value: currentUser.projectsSupported, icon: Target, color: "text-blue-600" },
    { label: "Schools Helped", value: "3", icon: Building, color: "text-purple-600" },
    { label: "Impact Score", value: "Gold", icon: Award, color: "text-yellow-600" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-blue-50 to-purple-50 overflow-x-hidden">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-3 bg-white/60 backdrop-blur-sm rounded-2xl px-4 py-2 border border-slate-200/50 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs text-slate-500">{currentUser.batch}</div>
                </div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              <div className="flex-1">
                ...
                <h1 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight">
                  ...
                  <br />
                  <span className="text-slate-800">Continues to Grow</span>
                </h1>
                
                <p className="text-xl text-slate-600 mb-8 leading-relaxed">
                  Discover new opportunities to support educational institutions and track the impact of your contributions across the globe.
                </p>
                ...
                <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-6 border border-slate-200/50 shadow-2xl shadow-blue-500/10">
                  ...
                  <div className="space-y-4">
                    {recentActivities.map((activity, index) => {
                      ...
                      return (
                        <div key={index} className="flex items-center space-x-3 p-3 rounded-xl bg-gradient-to-r from-blue-50 to-purple-50 hover:from-blue-100 hover:to-purple-100 transition-all duration-300">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="text-xs text-slate-600">{activity.school} • {activity.date}</div>
                          </div>
                        </div>
                      );
                    })}
      ...
      {/* Search Section */}
      <section className="py-12 bg-white/80 backdrop-blur-sm border-y border-slate-200/50" id="search" data-animate>
        <div className="max-w-7xl mx-auto px-6">
          <div
            className={`transform transition-all duration-1000 ${
          ...
          >
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-slate-800 mb-4">
                Find <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Schools to Support</span>
              </h2>
            </div>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              <div className="relative group">
                ...
                <div className="relative bg-white/90 backdrop-blur-xl rounded-3xl border border-slate-200/50 shadow-2xl shadow-blue-500/10 group-hover:shadow-blue-500/20 transition-all duration-500">
                  ...
                  <input
                    ...
                    className="w-full pl-20 pr-40 py-6 text-lg rounded-3xl bg-transparent focus:outline-none text-slate-700 placeholder-slate-400 transition-all duration-300"
                    onKeyPress={(e) => e.key === "Enter" && handleSearch(e)}
                  />
                  <button
                    onClick={handleSearch}
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-blue-500 to-purple-500 text-white px-8 py-3 rounded-2xl hover:from-blue-600 hover:to-purple-600 flex items-center space-x-3 transition-all duration-300 shadow-lg shadow-blue-500/25 font-semibold hover:scale-105"
                  >
                    <span>Search</span>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <div className="flex items-center space-x-3 bg-white/60 backdrop-blur-sm rounded-2xl px-4 py-2 border border-slate-200/50 shadow-lg">
      ...
      <section id="institutions" className="py-16 bg-gradient-to-br from-indigo-50 via-blue-50 to-purple-50" data-animate>
        <div className="max-w-7xl mx-auto px-6">
          <div
          ...
          >
            ...
            <h2 className="text-4xl font-bold text-slate-800 mb-4">
              Featured <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Institutions</span>
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {sortedInstitutions.map((institution, index) => (
              <div
                key={institution.id}
                className={`group bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl hover:shadow-2xl overflow-hidden transition-all duration-500 border border-slate-200/50 hover:border-blue-200 transform hover:scale-105 ${
                  isVisible.institutions ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"
                }`}
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-3 border border-white/20 shadow-lg">
                      <div className="text-xs text-slate-600 mb-1">Urgent Need</div>
                      <div className="text-sm font-bold text-slate-800">{institution.urgentNeed}</div>
                      <div className="text-xs text-blue-600 font-semibold">${institution.urgentAmount.toLocaleString()} needed</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="mb-4">
                    <div className="flex justify-between text-sm text-slate-600 mb-2">
                      <span>Progress</span>
                      <span>${institution.raised.toLocaleString()} of ${institution.totalNeeded.toLocaleString()}</span>
                    </div>
                    <div className="w-full bg-slate-200 rounded-full h-2">
                      <div 
                        className="bg-gradient-to-r from-blue-500 to-purple-500 h-2 rounded-full transition-all duration-700"
                        style={{ width: `${(institution.raised / institution.totalNeeded) * 100}%` }}
                      ></div>
                    </div>
                    <div className="text-xs text-slate-500 mt-1">
                      {Math.round((institution.raised / institution.totalNeeded) * 100)}% funded
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center text-slate-600">
                      ...
                      <span className="text-sm font-medium">{institution.alumni} alumni</span>
                    </div>
          ...
          {sortedInstitutions.length > 6 && (
            <div className="text-center mt-12">
              <button className="bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 text-white px-12 py-4 rounded-2xl hover:from-blue-600 hover:via-indigo-600 hover:to-purple-600 transition-all duration-300 shadow-xl shadow-blue-500/25 hover:shadow-blue-500/40 font-semibold hover:scale-105 flex items-center space-x-3 mx-auto">
